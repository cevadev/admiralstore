...
<%
  ...
  ArrayList<Category> categoryList = catDao.list();
%>
<!DOCTYPE html>
<html lang="es">
  <head>
          ...
          <div class="col-sm-3">
            <div class="left-sidebar">
              ...
              <div class="panel-group category-products" id="accordian"><!--category-productsr-->
                <!<!-- Establecemos una definicion que permite incluir codigo java en jsp -->
                <% 
                    int categoryId = 0;
                %>
                ...
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <h4 class="panel-title">
                      <a <% if(CategoryDAO.isSupper(categoryId)) {%> data-toggle="collapse" data-parent="#accordian" <% } %> href="#<%= categoryId %>">
                        <% if(CategoryDAO.isSupper(categoryId)) {%><span class="badge pull-right"><i class="fa fa-plus"></i></span><% } %>
                  ...
                  <div id="<%= categoryId %>" class="panel-collapse collapse">
                    <div class="panel-body">
                      <ul>
                        <% ArrayList<Category> listaSub = catDao.listarSubCategorias(categoryId); %>
                        <%
                          for(int isub=0; listaSub.size() > isub; isub++){
                            categoryId = listaSub.get(isub).getId();
                        %>
                        <li><a href="#"><%= listaSub.get(isub).getName() %> </a></li>
                        <%
                          }
                        %>
<!--                        <li><a href="#">Nike </a></li>
